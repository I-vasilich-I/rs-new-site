...
import image from '/public/assets/contribute.png';

const contributeOptions: OptionItemProps[] = [
  {
    title: 'Mentorship',
    description: 'Become a mentor and guide the next generation of developers. Sign up as a mentor here.',
    buttonLabel: 'Register as a mentor',
    href: 'https://app.rs.school/registry/mentor',
  },
  {
    title: 'Developer / Coordinator / Trainer',
    description: 'Contribute your skills as a developer, coordinator, or trainer. Fill out this form to get started.',
    ...
    <div className="contribute content">
      <div className="general">
        <div className="info">
          ...
          <Paragraph>
            Remember, teaching others is one of the best ways to learn – this is known as The Protégé Effect! There are
            several ways you can contribute, choose yours.
          </Paragraph>
        </div>
      ...
      <div className="contribute-options">
        {contributeOptions.map(({ title, description, buttonLabel, href }) => (
          <OptionItem key={title} title={title} description={description} buttonLabel={buttonLabel} href={href} />
        ))}
      </div>
      <Paragraph>
        Additionally, we provide feedback on LinkedIn, which can be a valuable asset for your professional development.
      </Paragraph>
    </div>
  </div>
);
