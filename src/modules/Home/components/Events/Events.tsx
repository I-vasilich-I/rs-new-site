import { Title, Subtitle, Paragraph, EventCard, EventCardProps, SectionLabel } from 'components';
  ...
  <div id="events" className="events container">
    <div className="events content">
      <div className="info">
        ...
        <Paragraph>
          During 9 years we have organized 150+ events for developers in different cities and countries.
        </Paragraph>
      </div>
      <div className="cards">
        {events.map(cardProps => (
          <EventCard key={cardProps.title} {...cardProps} />
        ))}
      </div>
    </div>
  </div>
